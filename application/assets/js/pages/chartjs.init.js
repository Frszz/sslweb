!(function (l) {
  ...
  (r.prototype.respChart = function (r, o, e, a) {
    ...
    (r.prototype.init = function () {
      ...
      this.respChart(l("#doughnut"), "Doughnut", { labels: ["Desktops", "Tablets"], datasets: [{ data: [300, 210], backgroundColor: ["#5867c3", "#ebeff2"], hoverBackgroundColor: ["#5867c3", "#ebeff2"], hoverBorderColor: "#fff" }] });
      ...
      this.respChart(l("#polarArea"), "PolarArea", {
        datasets: [{ data: [11, 16, 7, 18], backgroundColor: ["#f9c341", "#34c38f", "#fe544b", "#5867c3"], label: "My dataset", hoverBorderColor: "#fff" }],
