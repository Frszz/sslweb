              ...
              (i = [
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    var z = this.drawPath({ d: e, stroke: n, strokeWidth: l, fill: u, fillOpacity: 1, classes: x, strokeLinecap: h, strokeDashArray: O });
                    ...
                    var M = { el: z, j: i, realIndex: a, pathFrom: s, pathTo: r, fill: u, strokeWidth: l, delay: f };
                    return (
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    if (!(Array.isArray(e.config.dataLabels.enabledOnSeries) && e.config.dataLabels.enabledOnSeries.indexOf(r) < 0)) {
                      ...
                      x && (b = this.dataLabelsCorrection(a, s, l, r, n, p, parseInt(u.style.fontSize, 10))),
                        e.globals.zoomed || ((a = b.x), (s = b.y)),
                        b.textRects && (a + b.textRects.width < -20 || a > e.globals.gridWidth + 20) && (l = "");
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    if (c.globals.isXNumeric) {
                      var f = h;
                      c.globals.seriesX[h].length || (f = c.globals.maxValsInArrayIndex), (i = (c.globals.seriesX[f][d] - c.globals.minX) / this.xRatio - (r * this.seriesLen) / 2);
                    }
                    ...
                    var p = this.barHelpers.getColumnPaths({ barXPosition: g, barWidth: r, y1: n, y2: a, strokeWidth: o, series: this.series, realIndex: e.realIndex, i: h, j: d, w: c });
                    return (
                      c.globals.isXNumeric || (i += s),
                      this.barHelpers.barBackground({ bc: u, j: d, i: h, x1: g - o / 2 - r * this.visibleI, x2: r * this.seriesLen + o / 2, elSeries: l }),
                      { pathTo: p.pathTo, pathFrom: p.pathFrom, x: i, y: a, barXPosition: g }
                    );
                  },
                },
                {
              ...
              (i = [
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    var p = Math.abs(f - u),
                      x = this.barHelpers.getColumnPaths({ barXPosition: g, barWidth: s, y1: u, y2: f, strokeWidth: this.strokeWidth, series: this.seriesRangeEnd, i: h, j: l, w: n });
                ...
                },
                {
                  ...
                  value: function (t) {
                    var e = t.indexes,
                      ...
                      u = Math.abs(d - h),
                      f = this.barHelpers.getBarpaths({ barYPosition: o, barHeight: n, x1: h, x2: d, strokeWidth: this.strokeWidth, series: this.seriesRangeEnd, i: e.realIndex, j: e.j, w: c });
              ...
              (i = [
                {
                  ...
                  value: function (t, e, i, a) {
                    ...
                    var v = !n.config.xaxis.labels.showDuplicates && this.ctx.timeScale && "hours" !== this.ctx.timeScale.tickInterval && "minutes" !== this.ctx.timeScale.tickInterval;
                    return (
                ...
                },
                {
                  ...
                  value: function (t) {
                          ...
                          if ("category" === n.config.xaxis.type || n.config.xaxis.convertedCatToNumeric)
                            if (n.globals.isBarHorizontal) {
                              var a = n.globals.yLabelFormatters[0],
                                s = new B(e.ctx).getActiveConfigSeriesIndex();
                    ...
                    o.push(n.config.chart.toolbar.export.csv.headerCategory),
                              ...
                              if ((o.length && 0 === e && l.push(o.join(a)), t.data && t.data.length))
                                for (var s = 0; s < t.data.length; s++) {
                                  ...
                                  if ((r || (h.isFormatXY() ? (r = i[e].data[s].x) : h.isFormat2DArray() && (r = i[e].data[s] ? i[e].data[s][0] : "")), 0 === e)) {
                                    ...
                                    for (var c = 0; c < n.globals.series.length; c++) o.push(n.globals.series[c][s]);
                                  }
                      ...
                      (c += l.join(r)),
                      this.triggerDownload(encodeURI(c), n.config.chart.toolbar.export.csv.filename, ".csv");
                  },
                },
                {
                  key: "triggerDownload",
                    ...
                    if (i.config.xaxis.labels.show)
                      for (
                        var d = function (s) {
                            ...
                            (f.textContent = Array.isArray(h.text) ? h.text.join(" ") : h.text), u.node.appendChild(f), "" !== h.text && (e.drawnLabels.push(h.text), e.drawnLabelsRects.push(h)), (n += t);
                          },
                          u = 0;
                        u <= c - 1;
                        u++
              ...
              (i = [
                ...
                },
                {
                  ...
                  value: function (t, e, i, a) {
                    ...
                    for (var s = Math.log(e) / Math.log(10), n = Math.log(i) / Math.log(10), o = Math.abs(i - e) / a, l = [], c = e; a >= 0; ) l.push(c), (c += o), (a -= 1);
                    var h = l.map(function (t, a) {
                      t <= 0 && (t = 0.01);
                      var o = (n - s) / (i - e),
                        l = Math.pow(10, s + o * (t - s));
                      return Math.round(l / r.roundToBase(l, 10)) * r.roundToBase(l, 10);
                    });
                ...
                },
                {
                  ...
                  value: function (t, e, i) {
                    ...
                    var o = Math.abs(i - e);
                    if ((n.logarithmic && o <= 5 && (a.invalidLogScale = !0), n.logarithmic && o > 5)) (a.allSeriesCollapsed = !1), (a.yAxisScale[t] = this.logarithmicScale(t, e, i, n.tickAmount ? n.tickAmount : Math.floor(Math.log10(i))));
                ...
                },
                {
                  ...
                  value: function (t, e) {
                    ...
                    "left" === this.moveDirection
                      ? ((t = i.globals.minX + (i.globals.gridWidth / 15) * a.xRatio), (e = i.globals.maxX + (i.globals.gridWidth / 15) * a.xRatio))
                      : "right" === this.moveDirection && ((t = i.globals.minX - (i.globals.gridWidth / 15) * a.xRatio), (e = i.globals.maxX - (i.globals.gridWidth / 15) * a.xRatio)),
                      (t < i.globals.initialMinX || e > i.globals.initialMaxX) && ((t = i.globals.minX), (e = i.globals.maxX));
                    var n = { min: t, max: e };
                    i.config.chart.zoom.autoScaleYaxis && (s = new Mt(this.ctx).autoScaleY(this.ctx, s, { xaxis: n }));
                  ...
                  value: function (t) {
                    ...
                    return (
                      a.globals.isXNumeric && "datetime" === a.config.xaxis.type
                        ? (r = new At(this.ctx).xLabelFormat(a.globals.ttKeyFormatter, d, d, { i: void 0, dateFormatter: new tt(this.ctx).formatDate, w: this.w }))
                        : a.globals.isBarHorizontal || (r = a.globals.xLabelFormatter(d, c)),
                ...
                },
                {
                  ...
                  value: function (t, e) {
                    ...
                    for (var f = 0; f < t.length; f++) {
                      ...
                      if ((m.attr({ index: 0, j: f }), i.config.chart.dropShadow.enabled)) {
                      ...
                      t.forEach(function (t, l) {
                        ...
                        (e.dataRadiusOfPercent[l] = []),
                          ...
                          t.forEach(function (t, i) {
                            ...
                            (t += Math.abs(e.minValue)), (e.dataRadiusOfPercent[l][i] = t / a), (e.dataRadius[l][i] = e.dataRadiusOfPercent[l][i] * e.size), (e.angleArr[l][i] = i * e.disAngle);
                          }),
                  ...
                  value: function (t) {
                    for (
                      ...
                      var E = this.lineHelpers.calculatePoints({ series: e, x: s, y: n, realIndex: i, i: a, j: L, prevY: y }),
                        z = this._createPaths({ series: e, i: a, realIndex: i, j: L, x: s, y: n, pX: o, pY: l, linePath: w, areaPath: k, linePaths: h, areaPaths: d, seriesIndex: u });
                      (d = z.areaPaths),
                        (h = z.linePaths),
                        (o = z.pX),
                        (l = z.pY),
                    ...
                    return (
                      ...
                      window.TreemapSquared.generate(l, i.globals.gridWidth, i.globals.gridHeight).forEach(function (l, c) {
                        ...
                        l.forEach(function (r, n) {
                          ...
                          f.attr({ cx: o, cy: l, i: c, j: n, width: d - o, height: u - l });
                  ...
                  value: function () {
                    ...
                    if (
                      ...
                      if (
                        ...
                        var s = r.getDimensions(this.el.parentNode);
                    ...
                    t.svgWidth < 0 && (t.svgWidth = 0), t.svgHeight < 0 && (t.svgHeight = 0), g.setAttrs(t.dom.Paper.node, { width: t.svgWidth, height: t.svgHeight });
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    return new Promise(function (s, r) {
                      ...
                      (null === e || a.globals.allSeriesCollapsed) && i.series.handleNoData(), "treemap" !== a.config.chart.type && i.axes.drawAxis(a.config.chart.type, e.xyRatios), (i.grid = new zt(i));
                      ...
                      if (
                        ...
                        if ((a.config.tooltip.enabled && !a.globals.noData && i.w.globals.tooltip.drawTooltip(e.xyRatios), a.globals.axisCharts && (a.globals.isXNumeric || a.config.xaxis.convertedCatToNumeric)))
