...
(function (h) {
  ...
  function Ka(a, b, c, d) {
    var e = [],
      ...
      G = function (a) {
        if (c === k || c === i)
          (j = m[i]), (h = a.innerHTML.trim()), j && j._bAttrSrc ? (N(j.mData._)(d, h), r(j.mData.sort, a), r(j.mData.type, a), r(j.mData.filter, a)) : q ? (j._setter || (j._setter = N(j.mData)), j._setter(d, h)) : (d[i] = h);
        i++;
      };
    if (f)
      for (; f; ) {
  ...
  function wb(a) {
    ...
    for (g = 0; g < c; g++)
      (n = b[g]),
        ...
        G.columns.push({ data: i, name: n.sName, searchable: n.bSearchable, orderable: n.bSortable, search: { value: m.sSearch, regex: m.bRegex } }),
        r("mDataProp_" + g, i),
        d.bFilter && (r("sSearch_" + g, m.sSearch), r("bRegex_" + g, m.bRegex), r("bSearchable_" + g, n.bSearchable)),
  ...
  function qb(a) {
    for (
      var b = a.oClasses, c = a.sTableId, d = a.aLengthMenu, e = Array.isArray(d[0]), f = e ? d[0] : d, d = e ? d[1] : d, e = h("<select/>", { name: c + "_length", "aria-controls": c, class: b.sLengthSelect }), g = 0, j = f.length;
      g < j;
      g++
    )
  ...
  function Ha(a) {
    ...
    if (d || (!r && !f && !e && j == W(a) && j == n.length)) for (l = 0; l < j; l++) (i = ba(a, l)), null !== i && (c[i].sWidth = w(n.eq(l).width()));
    else {
      ...
      for (l = 0; l < i.length; l++)
        (o = c[i[l]]), (n[l].style.width = null !== o.sWidthOrig && "" !== o.sWidthOrig ? w(o.sWidthOrig) : ""), o.sWidthOrig && f && h(n[l]).append(h("<div/>").css({ width: o.sWidthOrig, margin: 0, padding: 0, border: 0, height: 1 }));
  ...
  function Y(a) {
    ...
    for (a = 0; a < n.length; a++) {
      ...
      for (c = f.length; b < c; b++)
        (g = f[b]), (j = e[g].sType || "string"), n[a]._idx === k && (n[a]._idx = h.inArray(n[a][1], e[g].asSorting)), d.push({ src: i, col: g, dir: n[a][1], index: n[a]._idx, type: j, formatter: l.ext.type.order[j + "-pre"] });
    }
    return d;
  }
  function ob(a) {
  ...
  s.register = o = function (a, b) {
    if (Array.isArray(a)) for (var c = 0, d = a.length; c < d; c++) s.register(a[c], b);
    else
          ...
          r = function (b, d) {
            ...
            for (t = d.length; k < t; k++) {
              ...
              if (Array.isArray(u)) {
                ...
                if (l !== null) {
                  s = h("<a>", { class: g.sPageButton + " " + m, "aria-controls": a.sTableId, "aria-label": i[u], "data-dt-idx": o, tabindex: s, id: c === 0 && typeof u === "string" ? a.sTableId + "_" + u : null })
                    .html(l)
                    .appendTo(b);
                  Xa(s, { action: u }, w);
                  o++;
