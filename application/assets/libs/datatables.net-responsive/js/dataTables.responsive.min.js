...
(function (d) {
  ...
  var o = d.fn.dataTable,
    i = function (a, b) {
      ...
      this.s.dt.settings()[0].responsive ||
        (b && "string" === typeof b.details ? (b.details = { type: b.details }) : b && !1 === b.details ? (b.details = { type: !1 }) : b && !0 === b.details && (b.details = { type: "inline" }),
  ...
  d.extend(i.prototype, {
        ...
        g = function (c, d, g, k) {
          if (g)
            if ("max-" === g) {
              ...
              if ("not-" === g) {
                d = 0;
                for (g = b.length; d < g; d++) -1 === b[d].name.indexOf(k) && f(c, b[d].name);
              }
            }
      ...
      e.each(function (a, c) {
        for (var e = a.className.split(" "), f = !1, i = 0, m = e.length; i < m; i++) {
          ...
          d.each(b, function (a, b) {
            ...
            e && ((f = !0), e[2] === d[0] && e[3] === "-" + d[1] ? g(c, b.name, e[1], e[2] + e[3]) : e[2] === d[0] && !e[3] && g(c, b.name, e[1], e[2]));
          });
        }
        f || (a.auto = !0);
      });
    ...
    _detailsObj: function (a) {
      ...
      return d.map(this.s.columns, function (e, f) {
        if (!e.never && !e.control) {
          ...
          return { className: g.sClass, columnIndex: f, data: c.cell(a, f).render(b.c.orthogonal), hidden: c.column(f).visible() && !b.s.current[f], rowIndex: a, title: null !== g.sTitle ? g.sTitle : d(c.column(f).header()).text() };
        }
      });
    },
    _find: function (a) {
    ...
    _tabIndexes: function () {
      ...
      "number" === typeof e
        ? a.cells(null, e, { page: "current" }).nodes().to$().attr("tabIndex", c.iTabIndex).data("dtr-keyboard", 1)
      ...
      return function (a, b, c) {
        return (a = d
          .map(c, function (a) {
            ...
            return a.hidden
              ? "<li " + b + ' data-dtr-index="' + a.columnIndex + '" data-dt-row="' + a.rowIndex + '" data-dt-column="' + a.columnIndex + '"><span class="dtr-title">' + a.title + '</span> <span class="dtr-data">' + a.data + "</span></li>"
              : "";
          })
          .join(""))
  ...
  p.register("responsive.hasHidden()", function () {
    ...
    return a._responsive ? -1 !== d.inArray(!1, a._responsive._responsiveOnlyHidden()) : !1;
  });
